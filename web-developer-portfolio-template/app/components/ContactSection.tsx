			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6">
				...
				<div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
					<a
						...
						className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl font-medium hover:from-blue-500 hover:to-blue-600 transition-all duration-300 group"
					>
					...
					<a
						href="mailto:franpa619@gmail.com"
						className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-600 to-purple-700 rounded-xl font-medium hover:from-purple-500 hover:to-purple-600 transition-all duration-300 group"
					>
				...
				<div className="text-center mb-12">
					...
					<a
						href="https://drive.google.com/file/d/1Qfgltw-9aJw7HCT99Z4wsMA2C986qiNr/view?usp=sharing"
						target="_blank"
				...
				<div className="flex justify-center gap-6">
					<a
						href="https://github.com/franpa13"
						target="_blank"
						rel="noopener noreferrer"
